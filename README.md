...
### ![texto](https://img.shields.io/static/v1?label=MSAzure&message=GOOGLE/STORAGE&color=black&style=flat-square "Cloud")  ![texto](https://img.shields.io/static/v1?label=MSAzure&message=BIGQUERY&color=black&style=flat-square "Cloud")
## Amazon Web Services
### Sagemaker
<!--
